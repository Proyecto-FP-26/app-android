package com.fpfomento.android_app.api.infrastructure

import org.apache.oltu.oauth2.client.request.OAuthClientRequest.AuthenticationRequestBuilder
import org.apache.oltu.oauth2.client.request.OAuthClientRequest.TokenRequestBuilder
import com.fpfomento.android_app.api.auth.OAuth
import com.fpfomento.android_app.api.auth.OAuth.AccessTokenListener
import com.fpfomento.android_app.api.auth.OAuthFlow
...
class ApiClient(
    ...
    constructor(
        ...
        authNames.forEach { authName ->
            val auth: Interceptor? = when (authName) { 
                "OAuth2PasswordBearer" -> OAuth(OAuthFlow.password, "", "/auth/token", "")
    ...
    companion object {
        protected const val BASE_URL_KEY: String = "com.fpfomento.android_app.api.baseUrl"
        @Deprecated(
